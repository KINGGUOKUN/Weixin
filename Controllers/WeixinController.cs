...
using Weixin.MessageHandlers;

namespace Weixin.Controllers
{
    public partial class WeixinController : Controller
    {
        public static readonly string URL = WebConfigurationManager.AppSettings["WeixinUrl"];//与微信公众账号后台的Token设置保持一致，区分大小写。
        ...
        public static readonly string Secret = WebConfigurationManager.AppSettings["WeixinSecret"];//与微信公众账号后台的AppId设置保持一致，区分大小写。
